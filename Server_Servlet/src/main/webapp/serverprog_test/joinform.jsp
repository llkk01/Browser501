...
java package는 test_serverporg.Member, test_serverporg.MemberDao에 위치<br>
Oracle DB는 jsp/jsp의 Member1 테이블 사용<hr>
...
<img src="server_prog.png" width="500" height="500">
